...
/*   Updated: 2018/08/10 15:42:51 by ttshivhu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		run_ranlibs(char *fn, t_ranlibs * head, int size)
{
	t_ranlibs	*current;
	unsigned char	*tmp;
	char		*name;
...
void		add_ranlib(char *fn, unsigned char *ptr, int size)
{
	t_ranlibs	*head;
	int		i;
